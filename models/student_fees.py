...
class StudentFees(models.Model):
    ...
    def action_create_invoice(self):
        ...
        # user click count manage
        self.ensure_one()

        # raise UserError(_("working"))
        ...
        invoice_values = {
            ...
            # Payment Reference  pass -> account.move -> invoice Reference
            'ref': self.name,
    ...
    def _compute_amount_total(self):
        for record in self:
            ...
            if record.student_id and record.course_id:
                ...
                # find -> student_id and course_id true
    ...
    def _check_payment_amount(self):
        for record in self:
            ...
            if record.amount_total == 0:
                raise ValidationError(_("This course fee is already fully paid. "))
